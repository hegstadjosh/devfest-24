...
sys_msg = "You are a text analysis machine. You read journal entries of users and jot down certain mental health markers, graded on the following criteria from 0 to 9 (0 is least healthy): {metrics}. The default value is -1 (not enough info to grade). \
...
ast_response_1 = "\"gratitude\":9\n\"goal-orientation\":3\n\"social-support\":7\n\"happiness\":8\n\"anger\":-1\n\"satisfaction\":8\n\"self-esteem\":7% Wow, it sounds like you have have a very positive environment and outlook on life. I'm curious, what is it that made you want to start journaling? Do you ever have doubts about your purpose or direction in life?"
...
metric_messages.append(assistant_message)
ai_test.pretty_print_conversation(metric_messages)
...
while True:
  ...
  metric_messages.append({"role": "user", "content": user_input})
  chat_response = ai_test.chat_completion_request(
      messages=metric_messages
  )
  ...
  metrics.append(text_response[0])
